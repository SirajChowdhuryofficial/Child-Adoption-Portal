    ...
    <header class="site-navbar mt-3">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="site-logo col-6"><a href="Home.php"><img src="images/adoptbd.png" height="80px" width="80px" text-align=center; alt="adoptbd"></a></div>
          ...
          <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
            <div class="ml-auto">
              <a href="login.php" class="cd-signup"><span class="mr-2 icon-lock_outline"></span>Log In</a>
            </div>
    ...
    <div class="main-agileinfo">
      <div class="agileits-top">
        <form action="action/signup.php" method="POST">
          <input class="text" type="text" placeholder="Enter Your Name" name="name" required>
          <input class="text email" type="email" name="email" placeholder="Email" required>
          <input class="text" type="text" placeholder="Enter Your city" name="city" required>
          <input class="text" type="password" name="psw" placeholder="Password" required>
          <input class="text w3lpass" type="password" name="psw-r" placeholder="Confirm Password" required>
          ...
          <input class="btn btn-primary btn-lg btn-block text-white btn-search" type="submit" value="SIGNUP">
        </form>
