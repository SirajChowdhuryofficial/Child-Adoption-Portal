...
{
  header(header: 'Location: center/Home.php');
}
elseif (isset($_SESSION['email'])) {
  header(header: 'Location: user/Home.php');
}
include "include/database.php";
$sql="SELECT * FROM child;";
          $result = mysqli_query(mysql: $connect, query: $sql) 
          or die("failed to query".mysqli_error($connect));
$child=mysqli_num_rows(result: $result);
$sql="SELECT * FROM centers;";
          $result = mysqli_query(mysql: $connect, query: $sql) 
          or die("failed to query".mysqli_error($connect));
$centers=mysqli_num_rows(result: $result);
$sql="SELECT * FROM users;";
          $result = mysqli_query(mysql: $connect, query: $sql) 
          or die("failed to query".mysqli_error($connect));
$users=mysqli_num_rows(result: $result);
$sql="SELECT * FROM adoption;";
          $result = mysqli_query(mysql: $connect, query: $sql) 
          or die("failed to query".mysqli_error($connect));
$adoption=mysqli_num_rows(result: $result);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <header class="site-navbar mt-3">
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <a href="Home.php"><img src="images/adoptbd.png" height="80px" width="80px" text-align=center; alt="adoptbd"></a>
          </div>
