                 ...
                 <table id="table" style="float: left;">
                     <tr>
                         <td style="width:50%">
                             ...
                             <h4><b>Name: </b><?php echo htmlspecialchars($row['name']); ?></h4>
                             <h6><b>Age: </b><?php echo $age; ?> Years</h6>
                             <h6><b>Religion: </b><?php echo htmlspecialchars($row['religion']); ?></h6>
                         </td>
                         <td>You need to be logged in to see the full details</td>
                     </tr>
                 </table>
                 <?php
                 $serial++;
