...
<div class="site-wrap">
        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li class="d-lg-none"><a href="login.html" class="nav-link active">Log In</a></li>
            </ul>
          </nav>
    ...
    <section style="background-image: url('images/ban.jpg'); height:100px;">
     <div class="container">
        <h1 style="text-align: center;color: white;">User Log-in</h1>
      </div>
    </section>
...
<div class="main-w3layouts wrapper">
    <div class="main-agileinfo">
      <div class="agileits-top">
        <form action="action/user_login.php" method="POST">
          <input class="text email" type="email" name="email" placeholder="Email" required>
          <input class="text" type="password" name="psw" placeholder="Password" required>
          <input class="btn btn-primary btn-lg btn-block text-white btn-search" type="submit" value="Login" style="width:95%;">
        </form>
